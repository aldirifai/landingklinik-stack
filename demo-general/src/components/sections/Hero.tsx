...
export function Hero() {
  return (
    <section
      id="top"
      className="relative overflow-hidden bg-gradient-to-b from-brand-50 via-white to-canvas pt-28 pb-20 sm:pt-32 sm:pb-24 lg:pt-36"
    >
      ...
      <div className="container-page grid gap-12 lg:grid-cols-[1.1fr,1fr] lg:items-center">
        <div className="max-w-2xl">
          ...
          <h1 className="mt-5 text-4xl font-bold leading-[1.1] text-ink sm:text-5xl lg:text-[3.5rem]">
            {clinic.tagline}
          </h1>
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            ...
            <LinkButton href="#treatments" variant="secondary" size="lg">
              Lihat layanan
        ...
        <div className="relative">
          <div className="relative mx-auto aspect-square w-full max-w-md">
            ...
            <div className="absolute -bottom-6 -left-6 hidden rounded-lg bg-white p-4 shadow-cardHover sm:block">
            ...
            <div className="absolute -top-4 -right-4 hidden rounded-lg bg-accent-500 px-4 py-3 text-ink shadow-cardHover sm:block">
